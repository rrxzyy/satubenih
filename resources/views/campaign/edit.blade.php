                    ...
                    <div
                        ...
                        <div class="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
                            <div class="relative">
                                ...
                                <h2 class="text-5xl font-bold text-gray-900 xl:text-6xl">You Can update the Form to edit your
                                    Campaign</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                        ...
                        <form action="{{ route('campaign.update', $campaign->id) }}" method="post"
                            ...
                            <div class="relative py-8">
                                <button type="submit"
                                    class="inline-block w-full px-5 py-4 text-lg font-medium text-center text-white transition duration-200 bg-green-600 rounded-lg hover:bg-green-700 ease">Update
                                    Campaign</button>
                            </div>
                        </form>
                    </div>
